...
from aos.qaps import QLearningAOS_APS
    ...
    **kwargs
    ...
    while (
        ...
        new_state = extract_state(
            ...
            last_operators=qaps.get_last_operators()
        )
